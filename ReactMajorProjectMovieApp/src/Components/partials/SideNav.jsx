  ...
  return (
    <div className="w-[20%] h-full p-8 border-r-1 border-zinc-400 ">
     ...
     <nav className="flex flex-col gap-2 text-zinc-400">
      ...
      <NavLink to="/movie" className="hover:text-white hover:bg-[#6556CD] p-3 font-g-regular transition-all duration-250 rounded-lg text-lg"><i className="ri-film-line mr-2"></i>Movies</NavLink>
      <NavLink to="/tvshows" className="hover:text-white hover:bg-[#6556CD] p-3 font-g-regular transition-all duration-250 rounded-lg text-lg"><i className="ri-tv-2-line mr-2"></i>TV Shows</NavLink>
      <NavLink to="/people" className="hover:text-white hover:bg-[#6556CD] p-3 font-g-regular transition-all duration-250 rounded-lg text-lg"><i className="ri-team-line mr-2"></i>People</NavLink>
     </nav>
